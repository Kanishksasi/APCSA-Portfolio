/* Kanishk Sasikumar, 10/11/2024
 * Activity 1.3.2
 */
import java.util.Scanner;
 
public class GuessChecker3
{
    ...
    System.out.println("Guess Value: " + guess);
    System.out.println("Random Value: " + r1 + r2 + r3 + r4);
    System.out.println("# of hitsCounter: " + hitsCounter);
    System.out.println("# of kinda near hits: " + close);
    System.out.println("# of near hits: " + kindaNearmiss);
